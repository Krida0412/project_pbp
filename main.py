...
class ContactApp(App):
    def build(self):
        ...
        self.name_input = TextInput(
            ...
            font_size=20,
            height=65,
            size_hint_y=None  # Memastikan tinggi diatur berdasarkan height
        )
        ...
        self.contacts_scroll = ScrollView(size_hint=(1, 1))  # Memastikan ScrollView memenuhi ruang yang tersisa
